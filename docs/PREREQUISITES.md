...
| org.springframework.boot:spring-boot-starter-webmvc | 4.0.5   | Spring Boot web framework |
| org.springframework.boot:spring-boot-starter-data-mongodb | 4.0.5   | MongoDB persistence layer |
