...
object SHA256 {
    /**
     * Hashes a string using SHA-256 and returns the result as a lowercase hexadecimal string.
    ...
    /**
     * Hashes a byte array using SHA-256 and returns the result as a lowercase hexadecimal string.
